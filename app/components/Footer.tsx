...
`}</style>
            <div id="iv3be5" className="gjs-grid-row">
                <div id="ilriti" className="gjs-grid-column">
                    <div id="im0rle" className="gjs-grid-row">
                        <div id="iotp6j" className="gjs-grid-column">
                            <a href="/" id="iih6cv" className="gjs-link-box">
                                <div data-type-icon id="ip6zoj" className="gjs-icon">
                        ...
                        <div id="i1hx7l" className="gjs-grid-column">
                            ...
                            <a id="ipjdtn" href="##" className="gjs-link">
                                Terms &amp; Conditions
                                <br />
                            </a>
                            <a id="ikj01e" href="##" className="gjs-link">
                                Refund Policy
                                <br />
                            </a>
                            <a id="i2sl68" href="##" className="gjs-link">
                                Contact Us
                                <br />
                            </a>
                        </div>
                    </div>
                    <div id="it6g1v" className="gjs-text-blue">
