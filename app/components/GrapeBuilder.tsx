...
const GrapeBuilder: React.FC = () => {
    const editorRef = useRef<HTMLDivElement | null>(null);
    const editorInstance = useRef<Editor | null>(null); // Reference for the editor instance
                        ...
                        buttons: [
                            {
                                ...
                                label: 'Desktop',
                                command: () => {
                                    editorInstance.current?.setDevice('Desktop');
                                },
                                active: true,
                            },
                            {
                                ...
                                label: 'Mobile',
                                command: () => {
                                    editorInstance.current?.setDevice('Mobile');
                                },
                            },
                        ],
                    },
