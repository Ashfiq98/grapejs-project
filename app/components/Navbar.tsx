	...
	#irfl3k {
		...
		height: 24px;
            ...
            <div id="i6po" className="gjs-grid-row">
                <div id="itjq" className="gjs-grid-column">
                    <div id="iyd2" className="gjs-grid-row">
                        <div id="iqjl" className="gjs-grid-column">
                            <a id="iucmr" href="/" className="gjs-link-box">
                                <div data-type-icon id="irfl3k" className="gjs-icon">
                        ...
                        <div id="iffs" className="gjs-grid-column">
                            <div id="it00l" className="gjs-grid-row">
                                <div id="irtfd" className="gjs-grid-column">
                                    <a id="icfyb" href="#feature-section" className="gjs-link">
                                        About
                                    </a>
                                    <a href="#feature-section" id="infmy1" className="gjs-link">
                                        Features
                                    </a>
                                </div>
                                <div id="icyzp" className="gjs-grid-column">
                                    <a id="i88iz" href="#testimonial-section" className="gjs-link">
                                        Testimonials
                                    </a>
                                </div>
                            </div>
                        ...
                        <div id="id7x" className="gjs-grid-column">
                            <a id="i1mew" className="gjs-button">
                                Join Waitlist
                            </a>
                        </div>
                    </div>
